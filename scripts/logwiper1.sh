...
MISC_FILES=(
  "/opt/pwnpad/easy-creds/easy-creds-*"
  "/opt/pwnpad/easy-creds/*.txt"
  "/opt/pwnpad/wireless/kismet/Kismet-*"
  "/opt/pwnpad/wireless/wifite/cracked.txt"
  "/opt/pwnpad/wireless/wifite/hs/"
)
