...
f_interface(){
  ...
  printf "$(f_colorize wlan1)3. wlan1  (USB Wifi adapter, use with new EvilAP)$(f_isdefault wlan1)\e[0m\n"
  printf "$(f_colorize wlan1mon)4. wlan1mon  (monitor mode interface)$(f_isdefault wlan1mon)\e[0m\n"
  printf "$(f_colorize at0)5. at0  (Use with old EvilAP)$(f_isdefault at0)\e[0m\n"
